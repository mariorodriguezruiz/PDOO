...
/*  Operación responsabilidad de la única instancia de Napakalaki, la cual pasa el control al
    ...
    {   
        ...
        // Si combat() de Player devuelve LoseAndConvert.
        if(combatResult == CombatResult.LoseAndConvert)
        {
            ...
            /* Reemplace tanto en la lista de jugadores (players) como en la variable
               currentPlayer al jugador actual por el nuevo CultistPlayer */
            int numJ = this.players.indexOf( this.currentPlayer ) ;
            this.players.set( numJ, cP ) ;
