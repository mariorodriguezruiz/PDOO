...
public class Player {
    ...
    /*  Constructor de copia a la clase Player para generar el
        CultistPlayer a partir del jugador. */
...
/*
    ...
    /* Se lanzará el dado y devolverá true si se obtiene un 6 y false en caso contrario.*/
