...
public class CardDealer {
    ...
    {       
        ...
        badConsequences = new BadConsequence("Pierdes una mano visible.", 0, 
            new ArrayList(Arrays.asList(TreasureKind.ONEHAND)),
            new ArrayList(Arrays.asList()));        
        prizes = new Prize(3, 1);        
        unusedMonsters.add(new Monster("El mal indecible impronunciable", 10, badConsequences, prizes, -2 ));
        
        // Testigos Oculares.
        badConsequences = new BadConsequence("Pierdes tus tesoros visibles. Jajaja.", 0, 999, 0);        
        prizes = new Prize(2, 1);        
        unusedMonsters.add(new Monster("Testigos Oculares", 6, badConsequences, prizes, 2 ));
        
        // El gran cthulhu.
        badConsequences = new BadConsequence("Hoy no es tu día de suerte. Mueres.", true);        
        prizes = new Prize(2, 5);        
        unusedMonsters.add(new Monster("El gran cthulhu", 20, badConsequences, prizes, 4 ));
        
        // Serpiente Político.
        badConsequences = new BadConsequence("Tu gobierno te recorta 2 niveles.", 2, 0, 0 ) ;        
        prizes = new Prize(2, 1);        
        unusedMonsters.add(new Monster("Serpiente Político", 8, badConsequences, prizes, -2 ));
        
        // Felpuggoth.
        badConsequences = new BadConsequence("Pierdes tu casco y tu armadura visible." 
                + "Pierdes tus manos ocultas.", 0,  
                new ArrayList(Arrays.asList(TreasureKind.HELMET, TreasureKind.ARMOR )) ,
                new ArrayList(Arrays.asList(TreasureKind.BOTHHAND)));
        prizes = new Prize(1, 1);        
        unusedMonsters.add(new Monster("Serpiente Político", 2, badConsequences, prizes, 5 ));
        
        // Shoggoth.
        badConsequences = new BadConsequence("Pierdes 2 niveles.", 2, 0, 0 ) ;        
        prizes = new Prize(4, 2);        
        unusedMonsters.add(new Monster("Shoggoth", 16, badConsequences, prizes, -4 ));
        
        // Lolitaggoth.
        badConsequences = new BadConsequence("Pintalabios negro. Pierdes 2 niveles.", 2, 0, 0 ) ;        
        prizes = new Prize(1, 1);        
        unusedMonsters.add(new Monster("Lolitaggoth", 16, badConsequences, prizes, 3 ));
        
        // ----------- FIN DE MONSTRUOS CON SECTARIOS ----------- \\
    }
    ...
    /* Para que se añadan al mazo de sectarios las 6 cartas de sectarios */
    private void initCultistCardDeck()
    {        
        unusedCultist.add(new Cultist( "SectarioBaboso", 1 )) ;
        unusedCultist.add(new Cultist( "SectarioLargo", 2 )) ;
        unusedCultist.add(new Cultist( "SectarioOjos", 1 )) ;
        unusedCultist.add(new Cultist( "SectarioOjo", 2 )) ;
        unusedCultist.add(new Cultist( "SectarioSaltarín", 1 ));
        unusedCultist.add(new Cultist( "SectarioHundido", 1 ));        
    }
    
    public Cultist nextCultist()
    {
        // Si el mazo está vacío.
        if (this.unusedCultist.isEmpty()) 
        {                       
            this.initCultistCardDeck(); 
            this.suffleCultist();            
        }                
