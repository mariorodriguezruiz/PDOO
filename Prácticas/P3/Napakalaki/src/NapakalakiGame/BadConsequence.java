...
public class BadConsequence {
    ...
    {
        for(int i = 0; i < this.getSpecificVisibleTreasures().size(); i++){
    ...
    {        
            for(int i = 0; i < this.getSpecificHiddenTreasures().size(); i++){
...
/*
    ...
    public BadConsequence adjustToFitTreasureLists( ArrayList<Treasure> v, ArrayList<Treasure> h )
    {
        ...
        else if(specificHiddenTreasures.isEmpty() && specificVisibleTreasures.isEmpty())
        {
            ...
            bc = new BadConsequence(text, levels, minVisible, minOcultos);
        }else
        {
            ...
            bc = new BadConsequence( this.text, this.levels, t_visibles, t_ocultos ) ;
        }        
        return bc;
    }
